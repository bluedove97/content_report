...
def run(report_path: str = ".tmp/analysis_report.html", recipient: str = None) -> None:
    ...
    subject = f"[종목 분석] {today.strftime('%Y년 %m월 %d일')} ({weekdays[today.weekday()]})"
